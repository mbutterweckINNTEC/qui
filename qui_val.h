...
static float3_t const qui_val_mv = {0.035 / 0.0625 * qui_val_scl, 0.02 / 0.0625 * qui_val_scl };
...
static float3_t qui_val_unt_ngon[] = {
	{ -1.f + 6.f + 2 * 0.1f, 0.f           - 2 * 0.8660254038f - 2 * 0.08660254038f, 0.f },
	{-0.5f + 6.f +2 *  0.1f, 0.8660254038f - 2 * 0.8660254038f - 2 * 0.08660254038f, 0.f },
	{ 0.5f + 6.f + 2 * 0.1f, 0.8660254038f - 2 * 0.8660254038f - 2 * 0.08660254038f, 0.f },
	{ 1.0f + 6.f + 2 * 0.1f, 0.0f          - 2 * 0.8660254038f - 2 * 0.08660254038f, 0.f },
	{ 0.5f + 6.f + 2 * 0.1f,-0.8660254038f - 2 * 0.8660254038f - 2 * 0.08660254038f, 0.f },
	{-0.5f + 6.f + 2 * 0.1f,-0.8660254038f - 2 * 0.8660254038f - 2 * 0.08660254038f, 0.f },
};

static float3_t qui_val_val_ngon[] = {
	{ -1.f + 1.5 + 0.1f, 0.f           - 0.8660254038f - 0.08660254038f, 0.f },
	{-0.5f + 1.5 + 0.1f, 0.8660254038f - 0.8660254038f - 0.08660254038f, 0.f },
	{ 3.5f + 1.5 + 0.1f, 0.8660254038f - 0.8660254038f - 0.08660254038f, 0.f },
	{ 4.0f + 1.5 + 0.1f, 0.0f          - 0.8660254038f - 0.08660254038f, 0.f },
	{ 3.5f + 1.5 + 0.1f,-0.8660254038f - 0.8660254038f - 0.08660254038f, 0.f },
	{-0.5f + 1.5 + 0.1f,-0.8660254038f - 0.8660254038f - 0.08660254038f, 0.f },
};
