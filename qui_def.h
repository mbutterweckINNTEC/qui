...
#define QUI_MAN_X_CLR (float3_t) { 1.0f, 0.4f, 0.5f }
#define QUI_MAN_Y_CLR (float3_t) { 0.25f, 1.0f, 0.5f }
#define QUI_MAN_Z_CLR (float3_t) { 0.25f, 1.f, 1.0f }
#define QUI_MAN_V_CLR (float3_t) { 1.0f, 0.9f, 0.5f }	/* view axis */
